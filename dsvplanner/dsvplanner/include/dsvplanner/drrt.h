...
namespace dsvplanner_ns {
    class Drrt {
        public:
            Drrt(volumetric_mapping::OctomapManager *manager, DualStateGraph *graph, DualStateFrontier *frontier, OccupancyGrid *grid);
            ~Drrt();
        ...
        protected:
            ...
            pcl::PointCloud<pcl::PointXYZ>::Ptr localThreeFrontier_ = pcl::PointCloud<pcl::PointXYZ>::Ptr(new pcl::PointCloud<pcl::PointXYZ>());
            pcl::PointCloud<pcl::PointXYZ>::Ptr globalThreeFrontier_ = pcl::PointCloud<pcl::PointXYZ>::Ptr(new pcl::PointCloud<pcl::PointXYZ>());
            pcl::PointCloud<pcl::PointXYZI>::Ptr sampledPoint_ = pcl::PointCloud<pcl::PointXYZI>::Ptr(new pcl::PointCloud<pcl::PointXYZI>());
