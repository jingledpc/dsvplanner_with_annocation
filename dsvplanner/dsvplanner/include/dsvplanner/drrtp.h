...
namespace dsvplanner_ns {
    ...
    public:
        ...
        */
         ...
         * @brief 清理Frontier的服务
        */
        bool cleanFrontierServiceCallback(dsvplanner::clean_frontier_srv::Request &req, dsvplanner::clean_frontier_srv::Response &res);
        
        /**
         * @brief Clear old tree and the last global frontier.
        */
